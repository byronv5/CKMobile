var trook = window.trook || {};
trook.dialog = function () {
...
}(), trook.dialog.confirm = function (e, t, n) {
    ...
    return i.find(".console-btn-confirm").click(function () {
        var e = t && t.call(i);
        e !== !1 && trook.dialog.hide();
    }), i.find(".console-btn-cancel").click(function () {
        n && n.call(i), trook.dialog.hide();
    }), i;
}, trook.dialog.alert = function (e, t) {
...
}, trook.dialog.payNotice = function (e, t, n) {
    e = e || function () {
        window.location.reload();
    }, t = t || function () {
        window.location.reload();
    };
    var r = trook.dialog.show({
        html: ['<div class="dialog-content" style="padding: 0 80px; text-align:left">', '<div class="content-title">请您在新打开的页面<br>上完成缴费。</div>', '<p style="padding-left: 50px">缴费完成前请不要关闭此窗口。<br>完成缴费后请根据您的情况点击下面的按钮：</p>', "</div>", '<div class="dialog-console clearfix_new" style="margin:25px auto;width:252px;">', '<a class="console-btn-confirm" href="#" onclick="return false;">已完成缴费</a>', '<a class="console-btn-cancel" href="#" onclick="return false;">缴费遇到问题</a>', "</div>"].join(""),
        width: 530,
        closeFn: n
    });
